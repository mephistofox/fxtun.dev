    ...
    <Card variant="glass" class="w-full max-w-md p-8 animate-fade-in-up">
      ...
      <div class="space-y-3">
        ...
        <a
          ...
          class="w-full inline-flex items-center justify-center gap-2.5 rounded-lg bg-[#FC3F1D] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#E5350F] transition-colors"
        >
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="h-5 w-auto" viewBox="7.4 6.1 8 12">
          ...
          <div class="flex items-center justify-between relative z-10">
            ...
            <div class="flex flex-col items-center">
              <div class="w-12 h-12 rounded-lg bg-surface border border-primary/20 flex items-center justify-center">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
