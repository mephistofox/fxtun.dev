  ...
  <div class="min-h-screen bg-background">
    ...
    <div class="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div class="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h2>1. Назначение</h2>
        <p>
          Настоящие Правила использования («Правила») определяют, что можно и чего нельзя делать
          в сервисе туннелирования fxtun. Они дополняют
          <RouterLink to="/terms" class="text-primary hover:underline">Условия использования</RouterLink>
          и действуют для всех пользователей независимо от тарифа.
        </p>
        <p>
          fxtun даёт инфраструктуру для публикации локальных сервисов в интернете. Мы обязаны
          держать платформу безопасной, стабильной и свободной от злоупотреблений. Нарушение
          настоящих Правил может привести к немедленной приостановке или удалению аккаунта.
        </p>

        <h2>2. Запрещённые действия</h2>
        <p>С помощью fxtun запрещается:</p>

        <h3>2.1. Вредоносное ПО и атаки</h3>
        <ul>
          <li>Размещать и распространять вредоносное ПО, шифровальщики, шпионские программы, вирусы;</li>
          <li>Создавать фишинговые страницы, формы сбора учётных данных и инфраструктуру социальной инженерии;</li>
          <li>Проводить атаки на отказ в обслуживании (DoS/DDoS) и атаки с усилением против любых целей;</li>
          <li>Сканировать порты и искать уязвимости в чужих системах без разрешения владельца;</li>
          <li>Держать управляющую инфраструктуру (C2) для ботнетов и заражённых устройств.</li>
        </ul>

        <h3>2.2. Противоправный контент</h3>
        <ul>
          <li>Размещать, передавать и распространять материалы с сексуальной эксплуатацией детей (CSAM) в любом виде;</li>
          <li>Распространять контент, нарушающий интеллектуальные права: пиратские копии, контрафакт;</li>
          <li>Содействовать противоправной деятельности, включая мошенничество, отмывание денег и торговлю людьми;</li>
          <li>Публиковать материалы, разжигающие насилие, ненависть или терроризм.</li>
        </ul>

        <h3>2.3. Спам и нежелательные рассылки</h3>
        <ul>
          <li>Пересылать спам, массовые незапрошенные письма и автоматические сообщения;</li>
          <li>Держать открытые почтовые релеи и прокси для незапрошенных рассылок;</li>
          <li>Собирать адреса электронной почты и персональные данные с чужих сайтов.</li>
        </ul>

        <h3>2.4. Злоупотребление инфраструктурой</h3>
        <ul>
          <li>Потреблять ресурсы в объёме, ухудшающем работу сервиса для других пользователей;</li>
          <li>Обходить ограничения тарифа, лимиты частоты запросов и контроль доступа;</li>
          <li>Исследовать, сканировать и проверять на уязвимости инфраструктуру fxtun без разрешения;</li>
          <li>Вскрывать, декомпилировать платформу fxtun или вмешиваться в её работу;</li>
          <li>Перепродавать, сублицензировать и перераспределять доступ к fxtun без письменного разрешения.</li>
        </ul>

        <h3>2.5. Отдельно про TCP- и UDP-туннели</h3>
        <ul>
          <li>Выставлять в интернет незащищённые или заведомо уязвимые сервисы: открытые базы данных, необновлённый SSH;</li>
          <li>Обходить туннелями политики сетевой безопасности вашей организации;</li>
          <li>Поднимать через туннели анонимные прокси и VPN-сервисы;</li>
          <li>Держать открытые публичные прокси (HTTP, SOCKS и любые другие), доступные произвольным третьим лицам;</li>
          <li>Туннелировать протоколы, предназначенные для сетевых атак (ARP-спуфинг, исчерпание DHCP и подобное).</li>
        </ul>

        <h2>3. Ваша ответственность</h2>
        <ul>
          <li>Вы полностью отвечаете за весь контент и трафик, проходящий через ваши туннели;</li>
          <li>Защитите локальный сервис до того, как откроете его туннелем: аутентификация, файрвол, шифрование;</li>
          <li>Следите за своими туннелями и за тем, кто к ним подключается;</li>
          <li>Храните API-токены и учётные данные в тайне, не передавайте их посторонним;</li>
          <li>Своевременно отвечайте на обращения о нарушениях и запросы нашей службы безопасности.</li>
        </ul>

        <h2>4. Применяемые меры</h2>
        <p>В ответ на нарушение Правил мы можем:</p>
        <ul>
          <li><strong>Предупредить:</strong> при первом незначительном нарушении мы сообщим вам и попросим устранить его;</li>
          <li><strong>Закрыть туннель:</strong> отдельные туннели, нарушающие Правила, могут быть закрыты немедленно;</li>
          <li><strong>Приостановить аккаунт:</strong> при повторных или серьёзных нарушениях доступ приостанавливается;</li>
          <li><strong>Удалить аккаунт:</strong> при тяжёлых нарушениях (вредоносное ПО, CSAM, атаки) — блокировка без предупреждения;</li>
          <li><strong>Обратиться в правоохранительные органы:</strong> о противоправной деятельности мы вправе сообщить и содействовать расследованию.</li>
        </ul>
        <p>
          Для выявления злоупотреблений мы можем анализировать метаданные соединений: IP-адреса,
          объём трафика, используемые порты. Содержимое туннелей мы <strong>не</strong> просматриваем —
          см. пункт 8.4
          <RouterLink to="/terms" class="text-primary hover:underline">Условий использования</RouterLink>.
        </p>

        <h2>5. Как сообщить о нарушении</h2>
        <p>
          Если вы считаете, что пользователь fxtun нарушает настоящие Правила, сообщите нам.
          Порядок описан на странице
          <RouterLink to="/abuse" class="text-primary hover:underline">Сообщить о нарушении</RouterLink>.
        </p>

        <h2>6. Изменения Правил</h2>
        <p>
          Мы можем время от времени обновлять настоящие Правила. О существенных изменениях сообщим
          через Сервис не позднее чем за 14 дней до вступления их в силу. Продолжение использования
          fxtun после этой даты означает согласие с новой редакцией.
        </p>
