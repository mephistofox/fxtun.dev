        ...
        >
          <div class="p-6 flex flex-col h-full">
            ...
            <div class="flex items-center gap-3 mb-3">
              ...
              >
                <!-- webhook -->
                <svg aria-hidden="true" v-if="uc.icon === 'webhook'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
                </svg>
                <!-- share -->
                <svg aria-hidden="true" v-else-if="uc.icon === 'share'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186 9.566-5.314m-9.566 7.5 9.566 5.314m0 0a2.25 2.25 0 1 0 3.935 2.186 2.25 2.25 0 0 0-3.935-2.186Zm0-12.814a2.25 2.25 0 1 0 3.933-2.185 2.25 2.25 0 0 0-3.933 2.185Z" />
                </svg>
                <!-- terminal -->
                <svg aria-hidden="true" v-else-if="uc.icon === 'terminal'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m6.75 7.5 3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" />
                </svg>
                <!-- gamepad -->
                <svg aria-hidden="true" v-else-if="uc.icon === 'gamepad'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                <!-- code -->
                <svg aria-hidden="true" v-else-if="uc.icon === 'code'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />
                </svg>
                <!-- cpu -->
                <svg aria-hidden="true" v-else-if="uc.icon === 'cpu'" class="h-5 w-5" :style="`color: hsl(var(--${uc.color}));`" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <div class="relative group/cmd">
              ...
              <div class="absolute top-2 right-2 opacity-0 group-hover/cmd:opacity-100 transition-opacity">
                ...
                >
                  ...
                  <svg aria-hidden="true" v-else class="h-3.5 w-3.5 text-type-http" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
